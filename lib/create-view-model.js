    ...
    function ViewModel(model) {
        ...
        (0, _utils.getAllMethodsAndProperties)(model).forEach(function (key) {
            ...
            if (isComputed(model, key)) {
                var derivation = extras.getAdministration(model, key).derivation; // Fixme: there is no clear api to get the derivation
            ...
            (0, _defineProperty2.default)(_this, key, {
                ...
                configurable: true,
                get: function get() {
                    if (isComputed(model, key)) return _this.localComputedValues.get(key).get();
